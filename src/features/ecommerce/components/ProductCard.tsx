...
const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
    ...
    return (
        <div className="relative bg-gray-300 rounded-t-2xl rounded-b-2xl cursor-pointer mb-10 w-56 h-full max-h-72 transition-transform transform hover:scale-105">
            <div className=" h-32 flex justify-center items-center">
                <img className="absolute z-20 w-[140px] rounded-full border border-gray-200 bg-white h-[140px] top-6 left-1/2 transform -translate-x-1/2 -translate-y-1/2 object-contain p-2" src={`http://localhost:3000/api/imagenes/${product.url_imagen}`} alt={product.nombre} />
                ...
                {/* <form>
                    <div className="flex">
                        ...
                        <div className="relative w-full">
                            <input type="search" className="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search for city or address" required />
